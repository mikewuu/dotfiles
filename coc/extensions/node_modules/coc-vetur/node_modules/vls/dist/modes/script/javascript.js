    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            doResolve(doc, item) {
                ...
                const fileFsPath = paths_1.getFileFsPath(doc.uri);
                const details = service.getCompletionEntryDetails(fileFsPath, item.data.offset, item.label, getFormatCodeSettings(config), item.data.source, {
...
function createApplyCodeActionCommand(title, uriTextEditMapping) {
    return {
        title,
...
function convertKind(kind) {
    switch (kind) {
        ...
        case 'script':
            return vscode_languageserver_types_1.CompletionItemKind.File;
        case 'directory':
            return vscode_languageserver_types_1.CompletionItemKind.Folder;
    }
