import { DocumentColorParams, DocumentFormattingParams, DocumentLinkParams, IConnection, TextDocumentPositionParams, ColorPresentationParams, InitializeParams, ServerCapabilities, DocumentSymbolParams, CodeActionParams } from 'vscode-languageserver';
import { ColorInformation, CompletionItem, CompletionList, Definition, Diagnostic, DocumentHighlight, DocumentLink, Hover, Location, SignatureHelp, SymbolInformation, TextDocument, TextEdit, ColorPresentation } from 'vscode-languageserver-types';
