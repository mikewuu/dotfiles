    ...
    init(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = params.initializationOptions.config
                ? _.merge(config_1.getDefaultVLSConfig(), params.initializationOptions.config)
            ...
            yield this.dependencyService.init(workspacePath, config.vetur.useWorkspaceDependencies);
    ...
    onDocumentLinks({ textDocument }) {
        ...
        const documentContext = {
            resolveReference: ref => {
                ...
                return vscode_uri_1.default.file(path.resolve(fsPath, '..', ref)).toString();
            }
        };
        const links = [];
