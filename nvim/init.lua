...
-- Code folding settings for nvim-ufo
vim.o.foldcolumn = '1'
vim.o.foldlevel = 99
...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Configure code-folding for nvim-ufo
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          ['<Tab>'] = cmp.mapping(function(fallback)
            ...
            local has_copilot_suggestions = copilot_suggestions.is_visible()

            -- If we have AI suggestions, prefer those since we've manually
            -- requested them.
            if has_copilot_suggestions then
              fallback()
